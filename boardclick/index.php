...
$title="Join";
$prebody=<<<EOT
<div class="col-md-12" style="background-image: url(/img/m1.jpg); background-size: 100% auto;">
<div class="row pt-5 pb-3" style="background-color:#00000080;">
    <div class="container py-5 text-center">
      <h1 class="display-2 text-light">Board Rocket Fuel</h1>
      <h3 class="text-light">Meaningful collaboration at the center of your Board operations.</h3>
